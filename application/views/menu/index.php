        ...
        <tbody>
          ...
          <?php foreach ($menu as $m) : ?>
            <tr>
              ...
              <td><?= $m['menu']; ?></td>
              <td>
                <a type="button" class="badge badge-success" data-toggle="modal" data-target="#modalmenu<?php echo $m['id']; ?>">edit</a>
                <a href="<?php echo base_url('menu/managementhapus/') . $m['id']; ?>" class="badge badge-danger">delete</a>
              </td>
            </tr>
            <?php $i++; ?>
          <?php endforeach; ?>
...
foreach ($menu as $m) : $no++; ?>
  <div class="modal fade" id="modalmenu<?php echo $m['id']; ?>" tabindex="-1" aria-labelledby="modalroleLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="modalmenuLabel">modal edit</h1>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
