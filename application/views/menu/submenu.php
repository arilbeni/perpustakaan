                ...
                <tbody>
                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active']; ?></td>
                            <td>
                                <a type="button" class="badge badge-success" data-toggle="modal" data-target="#modalsubmenu<?php echo $sm['id']; ?>">edit</a>
                                <a href="<?php echo base_url('menu/submenuhapus/') . $sm['id']; ?>" class="badge badge-danger">delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
...
foreach ($subMenu as $sm) : $no++; ?>
    <div class="modal fade" id="modalsubmenu<?php echo $sm['id']; ?>" tabindex="-1" aria-labelledby="modalsubmenu" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalsubmenu">modal edit</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
